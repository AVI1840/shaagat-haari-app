...
const S: Sec[] = [
  ...
  { title: "אכשרה 3 חודשים — אוכלוסיות מיוחדות", ref: "3", items: [
    { q: "מי זכאי ל-3 חודשים?", a: "אנשים עם מוגבלות (נכות כללית / נכות מעבודה / נכי צה\"ל / פטור ממס רפואי), מפונים, בני זוג של משרתי 90+ ימי מילואים, בני זוג של פצועים, חיילים משוחררים." },
    ...
    { q: "אילו מסמכים נדרשים?", a: "אנשים עם מוגבלות / נכי צה\"ל — נתוני ב\"ל או משהב\"ט. פטור ממס — אישור מס הכנסה. מפונים — אישור רשות מקומית. בני זוג של משרתי מילואים / בני זוג של פצועים — אישור משהב\"ט. חיילים משוחררים — נתוני ב\"ל." },
  ]},
